...
object Lists {
  ...
  /**
    ...
    */
  def max(xs: List[Int]): Int = if (xs.isEmpty) throw new NoSuchElementException else maxListElement(xs.head, xs.tail)

  def maxListElement(element: Int, list: List[Int]): Int = {
